...
const UnifiedSequenceInput = memo(({ 
  ...
  const inputModes = [
    { 
      ...
      icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
          ...
          <div>
            ...
            {(() => {
              ...
              return selectedExample ? (
                <div className="text-body" style={{ fontSize: 13, marginTop: 8 }}>
            ...
            {Object.keys(exampleProteins).length > 0 && (
              <div className="mt-4" data-tour="example-proteins">
                  ...
                  {Object.entries(exampleProteins).map(([key, protein]) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-3 py-2 text-xs rounded-lg border transition-colors disabled:opacity-50 whitespace-nowrap ${
                          isSelected
                            ? 'btn-primary'
                            : 'btn-outline'
                        }`}
            ...
            <div className="text-caption flex items-center" style={{ marginTop: 8 }}>
          ...
          <div>
            ...
            {proteinInfo && (
              <div className="text-body" style={{ fontSize: 13, marginTop: 8 }}>
                ...
                {isDemoMode && (
                  <span style={{ marginLeft: 8, padding: '2px 8px', fontSize: 11, fontWeight: 600, background: 'var(--brand-bg)', color: 'var(--brand-primary)', borderRadius: 'var(--radius-sm)' }}>
                    Demo
                  </span>
                )}
              </div>
