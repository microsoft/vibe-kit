...
Copy of backend/constants.py for the scoring container.
"""
...
# Matches microsoft/dayhoff @ main: temperature=1.0 (analysis/* and src/cgenerate.py
# defaults). min_p=0.05 mirrors the value used in production-quality runs
# (analysis/generate_cas9.py, generate_from_homologs.py production sweeps).
DEFAULT_PROMPT = "M"
