...
class SequenceExporter(ABC):
    ...
    def _get_metadata_dict(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            "model": params.get("model", "microsoft/Dayhoff"),
            ...
            "disclaimer": "Research prototype. Sequences are computationally generated and require experimental validation.",
        }
