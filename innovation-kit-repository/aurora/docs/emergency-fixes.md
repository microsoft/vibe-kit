...
- [prototyping-guide.md](prototyping-guide.md) - Advanced troubleshooting
...
```python
# 32×32 instead of 48×48 (50% less memory)
GRID_BOUNDS = {
...
# Fixed: 4 steps (24h) - Stable on 48×48
num_steps = 4
```
...
2. Get API key from [CDS](https://cds.climate.copernicus.eu/how-to-api)

3. Accept ERA5 license terms in CDS portal
...
ls -lh data/aurora_forecast_june8.nc  # Should exist
