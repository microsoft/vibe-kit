...
argument-hint: Ask about protein ensembles, BioEmu sampling, or the reference app
tools:
  - "edit"
  - "edit/editFiles"
...
This agent is your scientific partner for exploring protein conformational ensembles with Microsoft BioEmu.
...
- **Model details**: `.agents/skills/bioemu/docs/model-details.md` — architecture, training data, performance metrics
- **Application patterns**: `.agents/skills/bioemu/docs/application-patterns.md` — code examples for common workflows
- **API formats**: `.agents/skills/bioemu/docs/data-integration.md` — request/response schemas
- **Quick start**: `.agents/skills/bioemu/docs/quick-start.md` — setup instructions for reference app
...
The reference application in `.agents/skills/bioemu/assets/reference-app/` provides:

- React frontend with Molstar 3D viewer
- Flask backend with trajectory analysis
- Azure endpoint integration

**Setup guide**: `.agents/skills/bioemu/docs/quick-start.md`
