...
The Dayhoff Innovation Kit is installed at `.vibe-kit/innovation-kits/dayhoff/` with this structure:

```
.vibe-kit/innovation-kits/dayhoff/
├── INNOVATION_KIT.md              # Main manifest and entry point
...
└── customizations/
    ...
    └── Dayhoff Protein Design.chatmode.md      # This file
```
